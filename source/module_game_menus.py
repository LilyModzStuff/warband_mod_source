   ...
   [     (set_background_mesh, "mesh_pic_camp"), ],
    [
      ...
      ("camp_polygamy",[(assign, reg0, "$g_polygamy"),],"{reg0?Dis:En}able polygamy",
       ...
       ("add_amazon_companions", [
           (try_begin),
           (eq, "$g_amazon_companions", 0),
           (str_store_string, s0, "@Amazon companions are disabled"),
           (else_try),
           (eq, "$g_amazon_companions", 1),
           (str_store_string, s0, "@Amazon companions are already enabled"),
           (try_end),
       ], "{s0}",
        [
            (try_begin),
            (eq, "$g_amazon_companions", 0),
            (troop_join, "trp_tournament_master"),
            (troop_join, "trp_trainer"),
            (troop_join, "trp_constable_hareck"),
            (troop_join, "trp_ramun_the_slave_trader"),
            (troop_join, "trp_guide"),
            (troop_join, "trp_xerina"),
            (troop_join, "trp_dranton"),
            (troop_join, "trp_kradus"),
            (troop_join, "trp_tutorial_trainer"),
            (assign, "$g_amazon_companions", 1),
            (else_try),
            (eq, "$g_amazon_companions", 1),
            (display_message, "@Amazon Orda companions already added!"),
            (try_end),
            ]
        ),
       ("back",[],"Back",
