  ...
  ("game_troop_label_banner", 0, "tableau_with_transparency", 256, 256, -128, 0, 128, 256,
   [
       ...
       (else_try),           
           ...
           (call_script, "script_agent_troop_get_banner_mesh", -1, ":banner_troop"),
  ...
  ("round_shield_1", 0, "sample_shield_round_1", 512, 256, 0, 0, 0, 0,
   [
       ...
       (try_begin),
           (ge, ":banner_troop", 0),
           (troop_slot_eq, ":banner_troop", slot_troop_banner_scene_prop, -1),
           (call_script, "script_draw_banner_to_region", ":banner_troop", -50, 0, 10000, 10000, 8000, 8000, 10000, 8000, 1),
       (else_try),           
  ...
  ("kite_shield_1", 0, "sample_shield_matte", 512, 512, 0, 0, 0, 0,
   [
       ...
       (try_begin),
           (ge, ":banner_troop", 0),
           (troop_slot_eq, ":banner_troop", slot_troop_banner_scene_prop, -1),
           (call_script, "script_draw_banner_to_region", ":banner_troop", -57, 30, 10000, 10000, 8000, 8000, 10000, 8000, 1),
       (else_try),           
  ...
  ("kite_shield_4", 0, "sample_shield_matte", 512, 512, 0, 0, 0, 0,
   [
       ...
       (try_begin),
           (ge, ":banner_troop", 0),
           (troop_slot_eq, ":banner_troop", slot_troop_banner_scene_prop, -1),
           (call_script, "script_draw_banner_to_region", ":banner_troop", -50, 30, 10000, 10000, 8000, 8000, 10000, 8000, 1),
       (else_try),           
  ...
  ("heater_shield_1", 0, "sample_shield_matte", 512, 512, 0, 0, 0, 0,
   [
       ...
       (try_begin),
           (ge, ":banner_troop", 0),
           (troop_slot_eq, ":banner_troop", slot_troop_banner_scene_prop, -1),
           (call_script, "script_draw_banner_to_region", ":banner_troop", -55, 30, 10000, 10000, 8000, 8000, 10000, 8000, 1),
       (else_try),           
  ...
  ("heater_shield_2", 0, "sample_shield_matte", 512, 512, 0, 0, 0, 0,
   [
       ...
       (try_begin),
           (ge, ":banner_troop", 0),
           (troop_slot_eq, ":banner_troop", slot_troop_banner_scene_prop, -1),
           (call_script, "script_draw_banner_to_region", ":banner_troop", -50, 40, 10000, 10000, 8000, 8000, 10000, 8000, 1),
       (else_try),           
  ...
  ("pavise_shield_1", 0, "sample_shield_matte", 512, 512, 0, 0, 0, 0,
   [
       ...
       (try_begin),
           (ge, ":banner_troop", 0),
           (troop_slot_eq, ":banner_troop", slot_troop_banner_scene_prop, -1),
           (call_script, "script_draw_banner_to_region", ":banner_troop", -50, 0, 10000, 10000, 9800, 9800, 10000, 8000, 1),
       (else_try),           
  ...
  ("heraldic_armor_a", 0, "sample_heraldic_armor_a", 512, 512, 0, 0, 0, 0,
   [
       ...
       (try_begin),
           (ge, ":banner_troop", 0),
           (troop_slot_eq, ":banner_troop", slot_troop_banner_scene_prop, -1),
           (call_script, "script_draw_banner_to_region", ":banner_troop", -25, 40, 10000, 10000, 6000, 6000, 10000, 8000, 1),
       (else_try),           
  ...
  ("heraldic_armor_b", 0, "sample_heraldic_armor_b", 512, 512, 0, 0, 0, 0,
   [
       ...
       (try_begin),
           (ge, ":banner_troop", 0),
           (troop_slot_eq, ":banner_troop", slot_troop_banner_scene_prop, -1),
           (call_script, "script_draw_banner_to_region", ":banner_troop", 0, 50, 10000, 10000, 8000, 5000, 10000, 8000, 1),
       (else_try),           
  ...
  ("heraldic_armor_d", 0, "sample_heraldic_armor_d", 512, 512, 0, 0, 0, 0,
   [
       ...
       (try_begin),
           (ge, ":banner_troop", 0),
           (troop_slot_eq, ":banner_troop", slot_troop_banner_scene_prop, -1),
           (call_script, "script_draw_banner_to_region", ":banner_troop", 0, 50, 10000, 10000, 6000, 6000, 10000, 8000, 1),
       (else_try),           
...
##  ("custom_banner", 0, "objects", 256, 512, 0, 0, 0, 0,
##   [
##     (store_script_param, ":troop_no", 1),
##
##     (set_fixed_point_multiplier, 100),
...
# WSE horses BEGIN
  ("wse_charger", 0, "sample_WLONG10_heraldic", 1024, 1024, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_troop", 1),    
       (set_fixed_point_multiplier, 100),
       (try_begin),
           (ge, ":banner_troop", 0),
           (troop_slot_eq, ":banner_troop", slot_troop_banner_scene_prop, -1),  
           (call_script, "script_draw_banner_to_region", ":banner_troop", -5, 25, 1400, 3700, 3000, 3000, 1700, 10000, 0), 
           (init_position, pos1),
           (position_set_z, pos1, 100),
           (cur_tableau_add_mesh, "mesh_tableau_mesh_wse_charger", pos1, 0, 0),
           (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
           (call_script, "script_draw_banner_to_region", ":banner_troop", 60, 25, 3700, 3700, 3000, 3000, 1900, 10000, 0), 
           (init_position, pos1),
           (position_set_z, pos1, 100),
           (cur_tableau_add_mesh, "mesh_tableau_mesh_wse_charger", pos1, 0, 0),
           (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
...
################################################################################
    ...
    ("heraldic_shirt_a", 0, "shirt_a", 1024, 1024, 0, 0, 0, 0,
        [
            ...
            (ge, ":banner_troop", 0),
            (troop_slot_eq, ":banner_troop", slot_troop_banner_scene_prop, -1),
            (call_script, "script_draw_banner_to_region", ":banner_troop", -25, 40, 10000, 10000, 6000, 6000, 10000,
             8000, 1),
            (else_try),
            ...
            (init_position, pos1),
            (cur_tableau_add_mesh_with_vertex_color, "mesh_camo_tableau_shirt_a", pos1, 200, 100, ":background_color"),
            #       (cur_tableau_add_mesh, "mesh_heraldic_armor_bg", pos1, 200, 0),
            (init_position, pos1),
            ...
            (init_position, pos1),
            (position_set_z, pos1, 100),
            (cur_tableau_add_mesh, "mesh_camo_tableau_shirt_a", pos1, 0, 0),
            (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
         ]
    ),
    ("heraldic_arena_tunicW", 0, "arena_tunicW", 512, 512, 0, 0, 0, 0,
        [
            ...
            (init_position, pos1),
            (cur_tableau_add_mesh_with_vertex_color, "mesh_camo_tableau_arena_tunicW", pos1, 200, 100, ":background_color"),
            #       (cur_tableau_add_mesh, "mesh_heraldic_armor_bg", pos1, 200, 0),
            (init_position, pos1),
            ...
            (init_position, pos1),
            (position_set_z, pos1, 100),
            (cur_tableau_add_mesh, "mesh_camo_tableau_arena_tunicW", pos1, 0, 0),
            (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
        ]
    ),
    ("heraldic_rich_tunic_a", 0, "rich_tunic_a", 1024, 1024, 0, 0, 0, 0,
        [
            ...
            (init_position, pos1),
            (cur_tableau_add_mesh_with_vertex_color, "mesh_camo_tableau_rich_tunic_a", pos1, 200, 100,
             ":background_color"),
            #       (cur_tableau_add_mesh, "mesh_heraldic_armor_bg", pos1, 200, 0),
            (init_position, pos1),
            ...
            (init_position, pos1),
            (position_set_z, pos1, 100),
            (cur_tableau_add_mesh, "mesh_camo_tableau_rich_tunic_a", pos1, 0, 0),
            (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
        ]
    ),
    ("heraldic_tabard_b", 0, "tabard_b", 1024, 1024, 0, 0, 0, 0,
        [
            ...
            (init_position, pos1),
            (cur_tableau_add_mesh_with_vertex_color, "mesh_camo_tableau_tabard_b", pos1, 200, 100,
             ":background_color"),
            #       (cur_tableau_add_mesh, "mesh_heraldic_armor_bg", pos1, 200, 0),
            (init_position, pos1),
            ...
            (init_position, pos1),
            (position_set_z, pos1, 100),
            (cur_tableau_add_mesh, "mesh_camo_tableau_tabard_b", pos1, 0, 0),
            (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
        ]
    ),
    ("heraldic_padded_cloth_a", 0, "padded_cloth_a", 1024, 1024, 0, 0, 0, 0,
        [
            ...
            (init_position, pos1),
            (cur_tableau_add_mesh_with_vertex_color, "mesh_camo_tableau_padded_cloth_a", pos1, 200, 100,
             ":background_color"),
            #       (cur_tableau_add_mesh, "mesh_heraldic_armor_bg", pos1, 200, 0),
            (init_position, pos1),
            ...
            (init_position, pos1),
            (position_set_z, pos1, 100),
            (cur_tableau_add_mesh, "mesh_camo_tableau_padded_cloth_a", pos1, 0, 0),
            (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
        ]
    ),
    ("heraldic_padded_cloth_b", 0, "padded_cloth_b", 1024, 1024, 0, 0, 0, 0,
        [
            ...
            (init_position, pos1),
            (cur_tableau_add_mesh_with_vertex_color, "mesh_camo_tableau_padded_cloth_b", pos1, 200, 100,
             ":background_color"),
            #       (cur_tableau_add_mesh, "mesh_heraldic_armor_bg", pos1, 200, 0),
            (init_position, pos1),
            ...
            (init_position, pos1),
            (position_set_z, pos1, 100),
            (cur_tableau_add_mesh, "mesh_camo_tableau_padded_cloth_b", pos1, 0, 0),
            (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
        ]
    ),
    ("heraldic_archers_vest", 0, "archers_vest", 1024, 1024, 0, 0, 0, 0,
        [
            ...
            (init_position, pos1),
            (cur_tableau_add_mesh_with_vertex_color, "mesh_camo_tableau_archers_vest", pos1, 200, 100,
             ":background_color"),
            #       (cur_tableau_add_mesh, "mesh_heraldic_armor_bg", pos1, 200, 0),
            (init_position, pos1),
            ...
            (init_position, pos1),
            (position_set_z, pos1, 100),
            (cur_tableau_add_mesh, "mesh_camo_tableau_archers_vest", pos1, 0, 0),
            (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
          ]
    ),
    ("heraldic_leather_vest_a", 0, "leather_vest_a", 1024, 1024, 0, 0, 0, 0,
        [
            ...
            (init_position, pos1),
            (cur_tableau_add_mesh_with_vertex_color, "mesh_camo_tableau_leather_vest_a", pos1, 200, 100,
             ":background_color"),
            #       (cur_tableau_add_mesh, "mesh_heraldic_armor_bg", pos1, 200, 0),
            (init_position, pos1),
            ...
            (init_position, pos1),
            (position_set_z, pos1, 100),
            (cur_tableau_add_mesh, "mesh_camo_tableau_leather_vest_a", pos1, 0, 0),
            (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
        ]
    ),
    ("heraldic_sarranid_leather_armor", 0, "sarranid_leather_armor", 1024, 1024, 0, 0, 0, 0,
        [
            ...
            (init_position, pos1),
            (cur_tableau_add_mesh_with_vertex_color, "mesh_camo_tableau_sarranid_leather_armor", pos1, 200, 100,
             ":background_color"),
            #       (cur_tableau_add_mesh, "mesh_heraldic_armor_bg", pos1, 200, 0),
            (init_position, pos1),
            ...
            (init_position, pos1),
            (position_set_z, pos1, 100),
            (cur_tableau_add_mesh, "mesh_camo_tableau_sarranid_leather_armor", pos1, 0, 0),
            (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
        ]
    ),
    ("heraldic_tribal_warrior_outfit_a", 0, "tribal_warrior_outfit_a", 512, 512, 0, 0, 0, 0,
        [
            ...
            (init_position, pos1),
            (cur_tableau_add_mesh_with_vertex_color, "mesh_camo_tableau_tribal_warrior_outfit_a", pos1, 200, 100,
             ":background_color"),
            #       (cur_tableau_add_mesh, "mesh_heraldic_armor_bg", pos1, 200, 0),
            (init_position, pos1),
            ...
            (init_position, pos1),
            (position_set_z, pos1, 100),
            (cur_tableau_add_mesh, "mesh_camo_tableau_tribal_warrior_outfit_a", pos1, 0, 0),
            (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
        ]
    ),
    ("heraldic_light_mail_and_plate", 0, "light_mail_and_plate", 512, 512, 0, 0, 0, 0,
        [
            ...
            (init_position, pos1),
            (cur_tableau_add_mesh_with_vertex_color, "mesh_camo_tableau_light_mail_and_plate", pos1, 200, 100,
             ":background_color"),
            #       (cur_tableau_add_mesh, "mesh_heraldic_armor_bg", pos1, 200, 0),
            (init_position, pos1),
            ...
            (init_position, pos1),
            (position_set_z, pos1, 100),
            (cur_tableau_add_mesh, "mesh_camo_tableau_light_mail_and_plate", pos1, 0, 0),
            (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
        ]
    ),
    ("heraldic_mail_and_plate", 0, "mail_and_plate", 512, 512, 0, 0, 0, 0,
        [
            ...
            (init_position, pos1),
            (cur_tableau_add_mesh_with_vertex_color, "mesh_camo_tableau_mail_and_plate", pos1, 200, 100,
             ":background_color"),
            #       (cur_tableau_add_mesh, "mesh_heraldic_armor_bg", pos1, 200, 0),
            (init_position, pos1),
            ...
            (init_position, pos1),
            (position_set_z, pos1, 100),
            (cur_tableau_add_mesh, "mesh_camo_tableau_mail_and_plate", pos1, 0, 0),
            (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
        ]
    ),
    ("heraldic_cuir_bouilli_a", 0, "cuir_bouilli_a", 1024, 1024, 0, 0, 0, 0,
        [
            ...
            (init_position, pos1),
            (cur_tableau_add_mesh_with_vertex_color, "mesh_camo_tableau_cuir_bouilli_a", pos1, 200, 100,
             ":background_color"),
            #       (cur_tableau_add_mesh, "mesh_heraldic_armor_bg", pos1, 200, 0),
            (init_position, pos1),
            ...
            (init_position, pos1),
            (position_set_z, pos1, 100),
            (cur_tableau_add_mesh, "mesh_camo_tableau_cuir_bouilli_a", pos1, 0, 0),
            (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
        ]
    ),
    ("heraldic_brigandine_b", 0, "brigandine_b", 1024, 1024, 0, 0, 0, 0,
        [
            ...
            (init_position, pos1),
            (cur_tableau_add_mesh_with_vertex_color, "mesh_camo_tableau_brigandine_b", pos1, 200, 100,
             ":background_color"),
            #       (cur_tableau_add_mesh, "mesh_heraldic_armor_bg", pos1, 200, 0),
            (init_position, pos1),
            ...
            (init_position, pos1),
            (position_set_z, pos1, 100),
            (cur_tableau_add_mesh, "mesh_camo_tableau_brigandine_b", pos1, 0, 0),
            (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
            ]
    ),
    ("heraldic_arena_armorW", 0, "arena_armorW", 512, 512, 0, 0, 0, 0,
        [
            ...
            (init_position, pos1),
            (cur_tableau_add_mesh_with_vertex_color, "mesh_camo_tableau_arena_armorW", pos1, 200, 100,
             ":background_color"),
            #       (cur_tableau_add_mesh, "mesh_heraldic_armor_bg", pos1, 200, 0),
            (init_position, pos1),
            ...
            (init_position, pos1),
            (position_set_z, pos1, 100),
            (cur_tableau_add_mesh, "mesh_camo_tableau_arena_armorW", pos1, 0, 0),
            (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
        ]
    ),
    ("heraldic_mail_long_surcoat", 0, "mail_long_surcoat", 1024, 1024, 0, 0, 0, 0,
        [
            ...
            (init_position, pos1),
            (cur_tableau_add_mesh_with_vertex_color, "mesh_camo_tableau_mail_long_surcoat", pos1, 200, 100,
             ":background_color"),
            #       (cur_tableau_add_mesh, "mesh_heraldic_armor_bg", pos1, 200, 0),
            (init_position, pos1),
            ...
            (init_position, pos1),
            (position_set_z, pos1, 100),
            (cur_tableau_add_mesh, "mesh_camo_tableau_mail_long_surcoat", pos1, 0, 0),
            (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
        ]
    ),
    ("heraldic_full_plate", 0, "full_plate", 1024, 1024, 0, 0, 0, 0,
        [
            ...
            (init_position, pos1),
            (cur_tableau_add_mesh_with_vertex_color, "mesh_camo_tableau_full_plate", pos1, 200, 100,
             ":background_color"),
            #       (cur_tableau_add_mesh, "mesh_heraldic_armor_bg", pos1, 200, 0),
            (init_position, pos1),
            ...
            (init_position, pos1),
            (position_set_z, pos1, 100),
            (cur_tableau_add_mesh, "mesh_camo_tableau_full_plate", pos1, 0, 0),
            (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
        ]
    ),
