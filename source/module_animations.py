...
##   [ready_durn, "anim_human", combat+9500, combat+9508, blend_in_ready],
   ...
   #[ready_durn, "1h_low_thrust_30_9_10", 0, 13, blend_in_ready],
 ],
...
##   [0.62, "anim_human", combat+9507, combat+9530, blend_in_release],
   ...
   #[0.62, "1h_low_thrust_30_9_10", 13, 21, blend_in_release],
 ],
...
##   [0.1, "anim_human", combat+9530, combat+9540, blend_in_continue],
   ...
   #[0.1, "1h_low_thrust_30_9_10", 21, 39, blend_in_continue],
 ],
...
#   [10.0, "anim_human_temp", 0, 10, arf_blend_in_5],
 ...
 ["parried_overswing_spear", 0, amf_priority_parried|amf_use_weapon_speed|amf_play,
  [attack_parried_duration, "attacks_staff_thrust_overhead", 32, 28, arf_blend_in_2],
 ],
 ["blocked_overswing_spear", 0, amf_priority_blocked|amf_use_weapon_speed|amf_play,
  [attack_blocked_duration, "attacks_staff_thrust_overhead", 32, 28, arf_blend_in_2],
 ],
 ["reload_pistol_half", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   [1.2, "reload_pistol_new", 125, 250, arf_blend_in_3],
 ],
 ["ready_overswing_musket", acf_overswing|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
  #[ready_durn, "attacks_thrust_overhead2", 6, 21, blend_in_ready],
  [ready_durn, "attacks_thrust_overhead1", 0, 20, blend_in_ready],
 ],
 ["release_overswing_musket", acf_overswing|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next,
  #[0.6, "attacks_thrust_overhead2", 31, 45, blend_in_release],
  [0.6, "attacks_thrust_overhead1", 20, 41, blend_in_release],
 ],
 ["release_overswing_musket_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
  #[0.3, "attacks_thrust_overhead2", 45, 58, blend_in_release],
  [0.3, "attacks_thrust_overhead1", 41, 52, blend_in_release],
 ],
 ["parried_overswing_musket", 0, amf_priority_parried|amf_use_weapon_speed|amf_play,
  #[attack_parried_duration_thrust, "attacks_thrust_overhead2", 39, 21, arf_blend_in_2],
  [attack_parried_duration_thrust, "attacks_thrust_overhead1", 26, 22, arf_blend_in_2],
 ],
 ["blocked_overswing_musket", 0, amf_priority_blocked|amf_use_weapon_speed|amf_play,
  #[attack_blocked_duration_thrust, "attacks_thrust_overhead2", 39, 21, arf_blend_in_2],
  [attack_blocked_duration_thrust, "attacks_thrust_overhead1", 26, 22, arf_blend_in_2],
 ],
 ...
 ["curtsey", 0, amf_play,
    [1.0, "curtsey", 0, 39, arf_blend_in_0]],
 ["female_fucker", acf_enforce_all, amf_priority_die|amf_play,
	[0.6, "female_fucker", 0, 9, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],],
 ["female_fucker_1", acf_enforce_all, amf_priority_die|amf_play,
	[0.6, "female_fucker_1", 0, 9, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],],
 ["female_fucker_2", acf_enforce_all, amf_priority_die|amf_play,
	[0.6, "female_fucker_2", 0, 9, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],],
 ["fuck_female", acf_enforce_all, amf_priority_die|amf_play,
	[0.6, "fuck_female", 0, 8, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],],
 ["fuck_female_1", acf_enforce_all, amf_priority_die|amf_play,
	[0.6, "fuck_female_1", 0, 8, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],],
 ["fuck_female_2", acf_enforce_all, amf_priority_die|amf_play,
	[0.6, "fuck_female_2", 0, 8, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],],
 ["fuck_male", acf_enforce_all, amf_priority_die|amf_play,
	[0.6, "fuck_male", 0, 8, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],],
 ["fuck_male_1", acf_enforce_all, amf_priority_die|amf_play,
	[0.6, "fuck_male_1", 0, 8, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],],
 ["male_fucked", acf_enforce_all, amf_priority_die|amf_play,
	[0.6, "male_fucked", 0, 9, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],],
 ["male_masterb", acf_enforce_all, amf_priority_die|amf_play,
	[0.3, "male_masterb", 0, 4, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],],
 ["fuck_female_blow", acf_enforce_all, amf_priority_die|amf_play,
 ...
 ["dancer", acf_enforce_all, amf_priority_die|amf_play,
	[2.4, "dancer_1", 0, 23, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
	[1.9, "dancer_2", 0, 18, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
