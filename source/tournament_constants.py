...
wp_tpe_enhanced_horse                  = "itm_tournament_warhorse" # Can be setup with team colors, but line for it is commented out.
...
wp_tpe_bet_tier_3                      = 75
wp_tpe_bet_tier_4                      = 100
wp_tpe_bet_tier_5                      = 125 # change this value to set the maximum bet per round.
